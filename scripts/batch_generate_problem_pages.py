...
SKIPPED = []
BATCH_LABEL = "2023 AMC 10A Problems 1-10"
NEXT_START = "2023 AMC 10A Problem 11"

ANS={1:("E","27"),2:("A",r"1\frac45"),3:("A","8"),4:("D","12"),5:("E","18"),6:("D","126"),7:("B",r"\frac{49}{216}"),8:("D","37.5"),9:("E","9"),10:("D","7")}
...
KEY_OVERRIDES={1:"Use relative speed to find meeting distance.",2:"Set up a linear equation for pizza and orange-slice weights.",3:"A square divisible by 5 has a base divisible by 5.",4:"Use the quadrilateral inequality for the longest side.",5:"Rewrite powers to make a power of 10.",6:"Count how many times each vertex contributes to the face sum.",7:"Count roll sequences that first reach total 3.",8:"Use a linear conversion between Fahrenheit and Breadus.",9:"Track digit parity in the date string.",10:"Translate mean changes into equations."}
