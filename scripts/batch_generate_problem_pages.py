...
SKIPPED = []
BATCH_LABEL = "2022 AMC 10B Problems 21-25"
NEXT_START = "2023 AMC 10A Problem 1"

ANS={21:("E","23"),22:("E",r"136\pi"),23:("C",r"\frac23"),24:("B","50"),25:("A","6")}
...
KEY_OVERRIDES={21:"Use congruence remainders to solve for a cubic polynomial.",22:"Classify circles tangent to two concentric circles, then count tangencies to the third.",23:"Separate the stopping-time probability from the distance probability.",24:"Apply the Lipschitz condition twice and construct equality.",25:"Recognize the binary digits of the 2-adic inverse of 7."}
