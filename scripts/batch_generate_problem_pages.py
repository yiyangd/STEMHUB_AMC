...
BATCH_NUMBER = 135
CONTEST_DIR = "amc10"
ANSWER_KEY_URL = "https://artofproblemsolving.com/wiki/index.php/2023_AMC_10A_Answer_Key"
TARGET_NUMBERS = {12,13,14,16,17,18,19}
SKIPPED = ["2023 AMC 10A Problem 11 skipped: inscribed-square ratio depends on the missing shaded-triangle diagram.", "2023 AMC 10A Problem 15 skipped: nested-circle shaded-region problem depends on the missing diagram.", "2023 AMC 10A Problem 20 skipped: 3x3 coloring count references a sample grid diagram."]
BATCH_LABEL = "2023 AMC 10A Problems 12-14,16-19"
NEXT_START = "2023 AMC 10A Problem 21"

ANS={12:("B","14"),13:("C","3072"),14:("B",r"\frac{9}{200}"),16:("B","36"),17:("A","84"),18:("D","8"),19:("E","1")}
...
11:(r"All the high schools in a large school district are involved in a fundraiser selling T-shirts. Which choice is logically equivalent to the statement, \"No school bigger than Euclid HS sold more T-shirts than Euclid HS\"?",[("A","All schools smaller than Euclid HS sold fewer T-shirts than Euclid HS."),("B","No school that sold more T-shirts than Euclid HS is bigger than Euclid HS."),("C","All schools bigger than Euclid HS sold fewer T-shirts than Euclid HS."),("D","All schools that sold fewer T-shirts than Euclid HS are smaller than Euclid HS."),("E","All schools smaller than Euclid HS sold more T-shirts than Euclid HS.")]),
12:(r"A pair of fair $6$-sided dice is rolled $n$ times. What is the least value of $n$ such that the probability that the sum of the numbers face up on a roll equals $7$ at least once is greater than $\frac12$?",[("A","2"),("B","3"),("C","4"),("D","5"),("E","6")]),
13:(r"The positive difference between a pair of primes is equal to $2$, and the positive difference between the cubes of the two primes is $31106$. What is the sum of the digits of the least prime that is greater than those two primes?",[("A","8"),("B","10"),("C","11"),("D","13"),("E","16")]),
...
21:(r"Let $P(x)$ be a polynomial with rational coefficients such that when $P(x)$ is divided by $x^2+x+1$, the remainder is $x+2$, and when $P(x)$ is divided by $x^2+1$, the remainder is $2x+1$. There is a unique polynomial of least degree with these two properties. What is the sum of the squares of the coefficients of that polynomial?",[("A","10"),("B","13"),("C","19"),("D","20"),("E","23")]),
22:(r"Let $S$ be the set of circles in the coordinate plane that are tangent to each of the three circles with equations $x^2+y^2=4$, $x^2+y^2=64$, and $(x-5)^2+y^2=3$. What is the sum of the areas of all circles in $S$?",[("A",r"$48\pi$"),("B",r"$68\pi$"),("C",r"$96\pi$"),("D",r"$102\pi$"),("E",r"$136\pi$")]),
23:(r"Ant Amelia starts on the number line at $0$. For $n=1,2,3$, she chooses a time duration $t_n$ and an increment $x_n$ independently and uniformly at random from $(0,1)$. During the $n$th step she moves $x_n$ units in the positive direction, using $t_n$ minutes. If the total elapsed time has exceeded $1$ minute during the $n$th step, she stops at the end of that step; otherwise, she continues with the next step, taking at most $3$ steps in all. What is the probability that her final position is greater than $1$?",[("A",r"$\frac13$"),("B",r"$\frac12$"),("C",r"$\frac23$"),("D",r"$\frac34$"),("E",r"$\frac56$")]),
24:(r"Consider functions $f$ that satisfy \[|f(x)-f(y)|\le\frac12|x-y|\] for all real numbers $x$ and $y$. Of all such functions that also satisfy $f(300)=f(900)$, what is the greatest possible value of $f(f(800))-f(f(400))$?",[("A","25"),("B","50"),("C","100"),("D","150"),("E","200")]),
25:(r"Let $x_0,x_1,x_2,\ldots$ be a sequence of numbers, where each $x_k$ is either $0$ or $1$. For each positive integer $n$, define \[S_n=\sum_{k=0}^{n-1}x_k2^k.\] Suppose $7S_n\equiv1\pmod{2^n}$ for all $n\ge1$. What is the value of $x_{2019}+2x_{2020}+4x_{2021}+8x_{2022}$?",[("A","6"),("B","7"),("C","12"),("D","14"),("E","15")]),
...
4:(r"A quadrilateral has all integer side lengths, a perimeter of $26$, and one side of length $4$. What is the greatest possible length of one side of this quadrilateral?",[("A","9"),("B","10"),("C","11"),("D","12"),("E","13")]),
5:(r"How many digits are in the base-ten representation of $8^5\cdot5^{10}\cdot15^5$?",[("A","14"),("B","15"),("C","16"),("D","17"),("E","18")]),
6:(r"An integer is assigned to each vertex of a cube. The value of an edge is the sum of the values of the two vertices it touches, and the value of a face is the sum of the values of the four edges surrounding it. The value of the cube is the sum of the values of its six faces. Suppose the sum of the integers assigned to the vertices is $21$. What is the value of the cube?",[("A","42"),("B","63"),("C","84"),("D","126"),("E","252")]),
7:(r"Janet rolls a standard $6$-sided die $4$ times and keeps a running total of the numbers she rolls. What is the probability that at some point, her running total will equal $3$?",[("A",r"$\frac29$"),("B",r"$\frac{49}{216}$"),("C",r"$\frac{25}{108}$"),("D",r"$\frac{17}{72}$"),("E",r"$\frac{13}{54}$")]),
8:(r"Barb the baker creates a new temperature system for baking bread, Breadus, which is linearly based on Fahrenheit. Bread rises at $110^\circ$F, which is $0$ on the Breadus scale. Bread bakes at $350^\circ$F, which is $100$ on the Breadus scale. Bread is done when its internal temperature is $200^\circ$F. What is this temperature on the Breadus scale?",[("A","33"),("B","34.5"),("C","36"),("D","37.5"),("E","39")]),
9:(r"A digital display shows the current date as an $8$-digit integer consisting of a $4$-digit year, followed by a $2$-digit month, followed by a $2$-digit date within the month. For example, Arbor Day in 2023 is displayed as $20230428$. For how many dates in $2023$ will each digit appear an even number of times in the $8$-digit display for that date?",[("A","5"),("B","6"),("C","7"),("D","8"),("E","9")]),
10:(r"Maureen is keeping track of the mean of her quiz scores this semester. If Maureen scores an $11$ on the next quiz, her mean will increase by $1$. If she scores an $11$ on each of the next three quizzes, her mean will increase by $2$. What is the mean of her quiz scores currently?",[("A","4"),("B","5"),("C","6"),("D","7"),("E","8")]),
12:(r"How many three-digit positive integers $N$ satisfy both of the following properties? The number $N$ is divisible by $7$, and the number formed by reversing the digits of $N$ is divisible by $5$.",[("A","13"),("B","14"),("C","15"),("D","16"),("E","17")]),
...
14:(r"A number is chosen at random from among the first $100$ positive integers, and a positive integer divisor of that number is then chosen at random. What is the probability that the chosen divisor is divisible by $11$?",[("A",r"$\frac4{100}$"),("B",r"$\frac9{200}$"),("C",r"$\frac1{20}$"),("D",r"$\frac{11}{200}$"),("E",r"$\frac3{50}$")]),
...
17:(r"Let $ABCD$ be a rectangle with $AB=30$ and $BC=28$. Points $P$ and $Q$ lie on $\overline{BC}$ and $\overline{CD}$ respectively so that all sides of $\triangle ABP$, $\triangle PCQ$, and $\triangle QDA$ have integer lengths. What is the perimeter of $\triangle APQ$?",[("A","84"),("B","86"),("C","88"),("D","90"),("E","92")]),
18:(r"A rhombic dodecahedron is a solid with $12$ congruent rhombus faces. At every vertex, $3$ or $4$ edges meet, depending on the vertex. How many vertices have exactly $3$ edges meet?",[("A","5"),("B","6"),("C","7"),("D","8"),("E","9")]),
19:(r"The line segment formed by $A(1,2)$ and $B(3,3)$ is rotated to the line segment formed by $A'(3,1)$ and $B'(4,3)$ about the point $P(r,s)$. What is $|r-s|$?",[("A",r"$\frac14$"),("B",r"$\frac12$"),("C",r"$\frac34$"),("D",r"$\frac23$"),("E","1")]),
}

KEY_OVERRIDES={12:"Use the last digit of the reversed number and divisibility by 7.",13:"Use the chord of a 60-degree inscribed angle to locate the largest possible radius.",14:"Average over the chosen number and count divisors divisible by 11.",16:"Model wins between handedness groups and solve an integer equation.",17:"Use Pythagorean triples forced by the rectangle side lengths.",18:"Use Euler's formula and face-edge incidence.",19:"Find the rotation center as the intersection of perpendicular bisectors."}
...
11:[("Name the original statement",r"The statement says that there is no school satisfying both conditions: bigger than Euclid HS and sold more T-shirts than Euclid HS."),("Write the logical form",r"In logical language, it says, \"There does not exist a school that is both bigger than Euclid HS and sold more T-shirts than Euclid HS.\""),("Move one condition into the subject",r"An equivalent way to say this is: among the schools that sold more T-shirts than Euclid HS, none of them is bigger than Euclid HS."),("Compare with the choices",r"This matches choice B exactly: \"No school that sold more T-shirts than Euclid HS is bigger than Euclid HS.\""),("Conclude",r"The answer is $\boxed{\text{B}}$."),],
12:[("Use the complement",r"It is usually easier to count \"at least once\" by first counting \"never.\" A sum of $7$ on one roll has probability $\frac6{36}=\frac16$."),("Find the probability of no 7",r"The probability of not rolling a sum of $7$ on one roll is $\frac56$. For $n$ independent rolls, the probability of never getting a sum of $7$ is \[\left(\frac56\right)^n.\]"),("Set up the desired inequality",r"The probability of at least one sum of $7$ is \[1-\left(\frac56\right)^n.\] We need this to be greater than $\frac12$, so \[\left(\frac56\right)^n<\frac12.\]"),("Test small n values",r"For $n=3$, \[\left(\frac56\right)^3=\frac{125}{216}>\frac12.\] For $n=4$, \[\left(\frac56\right)^4=\frac{625}{1296}<\frac12.\]"),("Conclude",r"The least possible value is $\boxed{4}$."),],
13:[("Represent the twin primes",r"The two primes differ by $2$, so write them as $p$ and $p+2$."),("Use the difference of cubes",r"The difference of their cubes is \[(p+2)^3-p^3=6p^2+12p+8.\] This is given as $31106$."),("Solve for p",r"So \[6p^2+12p+8=31106,\] or \[p^2+2p-5183=0.\] Completing the square gives \[(p+1)^2=5184=72^2,\] so $p=71$."),("Find the next prime",r"The two primes are $71$ and $73$. The least prime greater than both is $79$."),("Sum the digits",r"The digit sum of $79$ is \[7+9=16.\]"),("Conclude",r"The answer is $\boxed{16}$."),],
...
21:[("Use the least possible degree",r"The two moduli are quadratic and relatively prime, so the least-degree polynomial can be taken to have degree less than $4$. Write \[P(x)=ax^3+bx^2+cx+d.\]"),("Reduce modulo x squared plus x plus 1",r"Modulo $x^2+x+1$, we have $x^2=-x-1$ and $x^3=1$. Thus the remainder is \[(c-b)x+(a-b+d).\] This must equal $x+2$."),("Reduce modulo x squared plus 1",r"Modulo $x^2+1$, we have $x^2=-1$ and $x^3=-x$. Thus the remainder is \[(-a+c)x+(-b+d).\] This must equal $2x+1$."),("Solve the coefficient equations",r"The equations are \[c-b=1,\quad a-b+d=2,\quad -a+c=2,\quad -b+d=1.\] From these, $c=b+1$, $a=b-1$, and $d=b+1$. Substituting into $a-b+d=2$ gives $b=2$."),("Find the polynomial",r"Therefore \[a=1,\quad b=2,\quad c=3,\quad d=3,\] so \[P(x)=x^3+2x^2+3x+3.\]"),("Conclude",r"The sum of the squares of the coefficients is \[1^2+2^2+3^2+3^2=23.\] The answer is $\boxed{23}$."),],
22:[("First use the two concentric circles",r"A circle tangent to both $x^2+y^2=4$ and $x^2+y^2=64$ must be tangent to circles centered at the origin with radii $2$ and $8$."),("Find the possible radii",r"There are two possible families. A circle in the annulus has center distance $5$ from the origin and radius $3$, because $5-3=2$ and $5+3=8$. A circle containing the smaller circle internally has center distance $3$ and radius $5$, because $5-3=2$ and $5+3=8$."),("Now use the third circle",r"The third circle has center $(5,0)$ and radius $\sqrt3$. For each family, tangency to this third circle means the new center must be at distance $r+\sqrt3$ or $|r-\sqrt3|$ from $(5,0)$."),("Count the centers",r"For $r=3$ and center distance $5$ from the origin, each of the two tangency distances gives two intersections, so there are $4$ such circles. For $r=5$ and center distance $3$ from the origin, the same triangle inequalities give $4$ more circles."),("Add the areas",r"The total area is \[4\cdot\pi(3^2)+4\cdot\pi(5^2)=36\pi+100\pi=136\pi.\]"),("Conclude",r"The answer is $\boxed{136\pi}$."),],
23:[("Separate time from distance",r"The stopping step depends only on the time variables $t_i$, while the final position depends on the distance variables $x_i$. These are independent, so we can combine the probabilities by cases."),("Find the stopping step",r"Because each $t_i$ is in $(0,1)$, Amelia cannot stop after step $1$. She stops after step $2$ exactly when \[t_1+t_2>1,\] which has probability $\frac12$ in the unit square. Otherwise she takes step $3$, also with probability $\frac12$."),("Compute the distance probability for two steps",r"If she stops after step $2$, her position is $x_1+x_2$. For two independent uniform variables, \[P(x_1+x_2>1)=\frac12.\]"),("Compute the distance probability for three steps",r"If she stops after step $3$, her position is $x_1+x_2+x_3$. The probability that this is at most $1$ is the volume of a simplex in the unit cube, \[\frac{1}{3!}=\frac16.\] Therefore \[P(x_1+x_2+x_3>1)=\frac56.\]"),("Combine the cases",r"The desired probability is \[\frac12\cdot\frac12+\frac12\cdot\frac56=\frac14+\frac5{12}=\frac{2}{3}.\]"),("Conclude",r"The answer is $\boxed{\frac23}$."),],
24:[("Use the given equality as an anchor",r"The condition $f(300)=f(900)$ is powerful because both $400$ and $800$ are close to one of these anchor points."),("Bound the first layer",r"By the Lipschitz condition, \[|f(400)-f(300)|\le50,\quad |f(800)-f(900)|\le50.\] Since $f(300)=f(900)$, the largest possible distance between $f(800)$ and $f(400)$ is $100$."),("Apply the Lipschitz condition again",r"Now apply the same condition to the inputs $f(800)$ and $f(400)$: \[|f(f(800))-f(f(400))|\le\frac12|f(800)-f(400)|\le50.\] So the desired expression cannot exceed $50$."),("Show the bound can be reached",r"The upper bound is attainable. For example, a piecewise linear function with slopes of magnitude at most $\frac12$ can pass through \[(-50,25),\ (50,-25),\ (300,0),\ (400,50),\ (800,-50),\ (900,0).\]"),("Evaluate the constructed case",r"For this construction, $f(300)=f(900)=0$, $f(800)=-50$, and $f(400)=50$. Then \[f(f(800))-f(f(400))=f(-50)-f(50)=25-(-25)=50.\]"),("Conclude",r"The greatest possible value is $\boxed{50}$."),],
25:[("Interpret the congruence as binary digits",r"The number $S_n$ is the integer formed by the first $n$ binary digits $x_0,x_1,\ldots,x_{n-1}$. The condition says these prefixes behave like the inverse of $7$ modulo powers of $2$."),("Find the 2-adic inverse pattern",r"Because $7=8-1$, the inverse of $7$ in the $2$-adic sense is \[\frac1{7}=1+\frac{6}{1-8}=1+6(1+8+8^2+\cdots).\] This identity is interpreted by matching binary coefficients modulo powers of $2$."),("Read off the bits",r"The expression \[1+6(1+8+8^2+\cdots)\] gives binary bits \[1,1,1,0,1,1,0,1,1,0,\ldots.\] After $x_0=1$, the pattern $1,1,0$ repeats."),("Locate the needed indices",r"For $k\ge1$, the repeated pattern says $x_k=0$ when $k$ is divisible by $3$, and $x_k=1$ otherwise."),("Apply this to 2019 through 2022",r"We have \[2019\equiv0,\quad2020\equiv1,\quad2021\equiv2,\quad2022\equiv0\pmod3.\] Thus \[x_{2019},x_{2020},x_{2021},x_{2022}=0,1,1,0.\]"),("Conclude",r"The requested value is \[0+2(1)+4(1)+8(0)=6.\] The answer is $\boxed{6}$."),],
1:[("Use relative speed",r"The two cyclists move toward each other, so the distance between them shrinks at \[18+12=30\] miles per hour."),("Find the meeting time",r"They start $45$ miles apart, so the time until they meet is \[\frac{45}{30}=1.5\text{ hours}.\]"),("Find Alicia's distance",r"Alicia starts from City $A$ and rides at $18$ miles per hour, so she travels \[18\cdot1.5=27\] miles."),("Answer the exact question",r"The problem asks how many miles from City $A$ they are when they meet, which is Alicia's distance from $A$."),("Conclude",r"The answer is $\boxed{27}$."),],
2:[("Name the pizza weight",r"Let $p$ be the weight of a large pizza, in pounds. One cup of orange slices weighs $\frac14$ pound."),("Set up the equality",r"The given balance is \[\frac13p+3\frac12\cdot\frac14=\frac34p+\frac12\cdot\frac14.\]"),("Move the orange terms together",r"The difference in orange slices is $3$ cups, so the orange-slice weight difference is \[3\cdot\frac14=\frac34.\] This equals the pizza-weight difference \[\frac34p-\frac13p=\frac5{12}p.\]"),("Solve for p",r"Thus \[\frac5{12}p=\frac34,\] so \[p=\frac34\cdot\frac{12}{5}=\frac95=1\frac45.\]"),("Conclude",r"The answer is $\boxed{1\frac45}$."),],
3:[("Translate the divisibility condition",r"If a perfect square $n^2$ is divisible by $5$, then $n$ itself must be divisible by $5$."),("Find the range for n",r"We need $n^2<2023$. Since $44^2=1936$ and $45^2=2025$, the possible values are $1\le n\le44$."),("Count multiples of 5",r"The multiples of $5$ from $1$ to $44$ are \[5,10,15,20,25,30,35,40.\]"),("Count them",r"There are $8$ such values of $n$, and each gives one positive perfect square."),("Conclude",r"The answer is $\boxed{8}$."),],
4:[("Use the longest-side condition",r"For a quadrilateral to exist, the longest side must be shorter than the sum of the other three sides."),("Turn perimeter into an inequality",r"If the greatest side has length $x$, then the other three sides sum to $26-x$. We need \[x<26-x.\]"),("Find the integer maximum",r"The inequality gives $2x<26$, so $x<13$. The greatest possible integer value is $12$."),("Check that it is possible",r"A quadrilateral with side lengths $12,5,5,4$ has perimeter $26$, includes a side of length $4$, and satisfies $12<5+5+4$."),("Conclude",r"The answer is $\boxed{12}$."),],
5:[("Rewrite the powers",r"Use \[8^5=(2^3)^5=2^{15}\] and \[15^5=(3\cdot5)^5=3^5\cdot5^5.\]"),("Combine powers of 2 and 5",r"The expression becomes \[2^{15}\cdot5^{10}\cdot3^5\cdot5^5=2^{15}\cdot5^{15}\cdot3^5.\]"),("Make a power of 10",r"Since $2^{15}\cdot5^{15}=10^{15}$, the number is \[3^5\cdot10^{15}=243\cdot10^{15}.\]"),("Count digits",r"The number $243\cdot10^{15}$ is $243$ followed by $15$ zeros, so it has \[3+15=18\] digits."),("Conclude",r"The answer is $\boxed{18}$."),],
6:[("Track how often each vertex is counted",r"Each vertex of a cube touches $3$ edges. Therefore, when all edge values are added, each vertex value is counted $3$ times."),("Relate edge sums to face sums",r"Each edge belongs to exactly $2$ faces. So when the six face values are added, each edge value is counted twice."),("Combine the two counts",r"The cube value is therefore \[2\cdot3\cdot(\text{sum of vertex values}).\]"),("Use the given vertex sum",r"The sum of the vertex values is $21$, so the cube value is \[6\cdot21=126.\]"),("Conclude",r"The answer is $\boxed{126}$."),],
7:[("Notice totals only increase",r"Because every die roll is positive, once the running total passes $3$, it can never return to $3$. So we only count sequences that hit $3$ exactly."),("Hit 3 on the first roll",r"If the first roll is $3$, the last three rolls can be anything. This gives \[6^3=216\] sequences."),("Hit 3 on the second roll",r"The first two rolls must be $(1,2)$ or $(2,1)$, and the last two rolls can be anything. This gives \[2\cdot6^2=72\] sequences."),("Hit 3 on the third roll",r"The only way to first reach $3$ on the third roll is $(1,1,1)$, and the last roll can be anything. This gives $6$ sequences."),("Divide by all outcomes",r"The favorable count is $216+72+6=294$, and the total number of roll sequences is $6^4=1296$. Thus \[\frac{294}{1296}=\frac{49}{216}.\]"),("Conclude",r"The answer is $\boxed{\frac{49}{216}}$."),],
8:[("Use a linear scale",r"The Breadus scale is linear in Fahrenheit. A change from $110^\circ$F to $350^\circ$F is a change of $240^\circ$F, corresponding to $100$ Breadus degrees."),("Find the conversion rate",r"Each Fahrenheit degree corresponds to \[\frac{100}{240}=\frac5{12}\] Breadus degrees."),("Measure from the zero point",r"The bread is done at $200^\circ$F, which is \[200-110=90^\circ\text{F}\] above the Breadus zero point."),("Convert",r"The Breadus temperature is \[90\cdot\frac5{12}=37.5.\]"),("Conclude",r"The answer is $\boxed{37.5}$."),],
9:[("Start with the fixed year digits",r"The year $2023$ contributes two $2$s, one $0$, and one $3$. The two $2$s are already even, so the month and day must contribute an odd number of $0$s and $3$s, and an even number of every other digit."),("Reduce to checking valid dates",r"There are not many month-day strings with four digits. We can organize the search by requiring the multiset of month-day digits to pair off all digits except one $0$ and one $3$."),("List the valid dates",r"Checking the valid 2023 calendar dates gives \[0113,0131,0223,0311,0322,1013,1031,1103,1130.\]"),("Count them",r"These correspond to $9$ dates in 2023."),("Conclude",r"The answer is $\boxed{9}$."),],
10:[("Name the current situation",r"Let Maureen currently have $n$ quiz scores with mean $m$. Then her current total score is $nm$."),("Use the next-quiz condition",r"If she scores $11$ on the next quiz, \[\frac{nm+11}{n+1}=m+1.\] Simplifying gives \[n+m=10.\]"),("Use the next-three-quizzes condition",r"If she scores $11$ on each of the next three quizzes, \[\frac{nm+33}{n+3}=m+2.\] Simplifying gives \[2n+3m=27.\]"),("Solve the two equations",r"From $n+m=10$, we have $n=10-m$. Substitute into the second equation: \[2(10-m)+3m=27,\] so $m=7$."),("Conclude",r"Her current mean is $\boxed{7}$."),],
12:[("Use the reversed-number condition first",r"If the reversed number is divisible by $5$, then its last digit is $0$ or $5$. The last digit of the reversed number is the hundreds digit of $N$, so the hundreds digit of $N$ must be $5$."),("Write the number",r"Let \[N=500+10a+b,\] where $a$ and $b$ are digits. We need $N$ to be divisible by $7$."),("Reduce modulo 7",r"Since $500\equiv3\pmod7$, the condition is \[10a+b+3\equiv0\pmod7.\] For each tens digit $a$, this determines $b$ modulo $7$."),("Count digit possibilities",r"For $a=0,1,\ldots,9$, the required digit $b$ is one of $0$ through $9$ in $14$ total cases. Equivalently, checking the multiples of $7$ from $500$ to $599$ gives $14$ multiples."),("Conclude",r"There are $\boxed{14}$ such integers."),],
13:[("Draw the locus idea",r"Fix Abdul and Chiang as two points $48$ feet apart. Points Bharat for which $\angle ABC$ is $60^\circ$ lie on arcs of circles where the segment between Abdul and Chiang is a chord."),("Use the chord formula",r"For a circle of radius $R$, a chord that subtends an inscribed angle of $60^\circ$ subtends a central angle of $120^\circ$. Thus \[48=2R\sin60^\circ=R\sqrt3,\] so \[R=16\sqrt3.\]"),("Find the farthest point from Abdul",r"The farthest point on that circle from Abdul is across the diameter from Abdul, so the maximum distance from Abdul is \[2R=32\sqrt3.\]"),("Square the distance",r"The question asks for the square of this distance: \[(32\sqrt3)^2=1024\cdot3=3072.\]"),("Conclude",r"The answer is $\boxed{3072}$."),],
14:[("Condition on the chosen number",r"The first number is chosen uniformly from $1$ to $100$. After that, each divisor of that number is equally likely."),("Identify useful numbers",r"A chosen divisor is divisible by $11$ only if the original number is divisible by $11$. So only $11,22,\ldots,99$ can contribute."),("Pair divisors",r"For $n=11m$, a divisor of $n$ is divisible by $11$ exactly when it is $11$ times a divisor of $m$. Thus the fraction of divisors of $n$ that are divisible by $11$ is \[\frac{d(m)}{d(11m)}.\]"),("Handle multiples of 11 up to 100",r"Here $m=1,2,\ldots,9$. None of these $m$ is divisible by $11$, so $d(11m)=2d(m)$. Therefore the probability contribution for each multiple of $11$ is $\frac12$."),("Average over all 100 choices",r"There are $9$ multiples of $11$ from $1$ to $100$, so the total probability is \[\frac{9}{100}\cdot\frac12=\frac9{200}.\]"),("Conclude",r"The answer is $\boxed{\frac9{200}}$."),],
16:[("Name the groups",r"Let there be $L$ left-handed players and $2L$ right-handed players, for a total of $3L$ players."),("Count games by handedness",r"There are \[\binom L2\] left-left games, \[\binom{2L}{2}\] right-right games, and \[2L^2\] mixed games."),("Introduce one variable",r"Let $x$ be the number of mixed games won by left-handed players. Then left-handed players won \[\binom L2+x\] games, while right-handed players won \[\binom{2L}{2}+(2L^2-x)\] games."),("Use the 40 percent condition",r"Left-handed wins are $40\%$ more than right-handed wins, so \[\binom L2+x=\frac75\left(\binom{2L}{2}+2L^2-x\right).\]"),("Test possible total sizes",r"The answer choices that can equal \(\binom{3L}{2}\) are $15$ with $L=2$, $36$ with $L=3$, and $66$ with $L=4$. Solving the equation gives $x=\frac{31}{4}$ for $L=2$, $x=18$ for $L=3$, and $x=\frac{65}{2}$ for $L=4$."),("Conclude",r"Only $L=3$ gives an integer possible number of mixed-game wins. Thus there are $3L=9$ players and \[\binom92=36\] total games. The answer is $\boxed{36}$."),],
17:[("Assign the side pieces",r"Let $BP=p$ and $DQ=q$. Then $PC=28-p$ and $CQ=30-q$."),("Use the first and third right triangles",r"Triangle $ABP$ has legs $30$ and $p$, so $30^2+p^2$ must be a square. Triangle $QDA$ has legs $q$ and $28$, so $q^2+28^2$ must be a square."),("Find the feasible legs",r"For a leg $30$ with $p<28$, the useful Pythagorean option is \[30^2+16^2=34^2,\] so $p=16$. For a leg $28$ with $q<30$, the useful option is \[21^2+28^2=35^2,\] so $q=21$."),("Check the middle triangle",r"Then \[PC=28-16=12,\quad CQ=30-21=9.\] Triangle $PCQ$ has legs $12$ and $9$, so \[PQ=\sqrt{12^2+9^2}=15,\] an integer."),("Compute the perimeter",r"The sides of $\triangle APQ$ are \[AP=34,\quad PQ=15,\quad QA=35.\] Therefore the perimeter is \[34+15+35=84.\]"),("Conclude",r"The answer is $\boxed{84}$."),],
18:[("Use face-edge incidence",r"The solid has $12$ rhombus faces. Each face has $4$ edges, and each edge belongs to $2$ faces, so the number of edges is \[E=\frac{12\cdot4}{2}=24.\]"),("Use Euler's formula",r"For a convex polyhedron, \[V-E+F=2.\] With $E=24$ and $F=12$, we get \[V-24+12=2,\] so $V=14$."),("Count edge incidences at vertices",r"The sum of the numbers of edges meeting at all vertices is $2E=48$."),("Set up variables",r"Let $x$ be the number of vertices where $3$ edges meet. Then $14-x$ vertices have $4$ edges meeting, so \[3x+4(14-x)=48.\]"),("Solve",r"This gives \[56-x=48,\] so $x=8$."),("Conclude",r"The answer is $\boxed{8}$."),],
19:[("Use the rotation center",r"The center of rotation must be equidistant from each point and its image. Therefore $P(r,s)$ lies on the perpendicular bisector of $\overline{AA'}$ and also on the perpendicular bisector of $\overline{BB'}$."),("Find the first perpendicular bisector",r"For $A(1,2)$ and $A'(3,1)$, the midpoint is \[(2,\frac32)\]. The slope of $\overline{AA'}$ is $-\frac12$, so the perpendicular slope is $2$. Thus \[s-\frac32=2(r-2).\]"),("Find the second perpendicular bisector",r"For $B(3,3)$ and $B'(4,3)$, the midpoint is \[(\frac72,3)\]. The segment is horizontal, so its perpendicular bisector is \[r=\frac72.\]"),("Solve for s",r"Substitute $r=\frac72$ into the first equation: \[s-\frac32=2\left(\frac72-2\right)=3,\] so \[s=\frac92.\]"),("Compute the requested value",r"Therefore \[|r-s|=\left|\frac72-\frac92\right|=1.\]"),("Conclude",r"The answer is $\boxed{1}$."),],
}
...
def main():
    ...
    rows = [
        r
        for r in all_rows
        if r["year"] == "2023" and r["form"] == "A" and int(r["problem_no"]) in TARGET_NUMBERS
    ]
